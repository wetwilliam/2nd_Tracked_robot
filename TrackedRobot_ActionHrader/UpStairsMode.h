...
int mode_021();	/*---for out door2 ---*/
void mode_03();	/*---for out door3 ---*/
void mode_04(); /*---for out door4 ---*/
...
void mode_3()	//---up stairs prepare
{
	...
	if(angg<45 && angg>20)
	{
		...
		/*---01---*/
		legma((90
         -angg)*300,(90-angg)*300); //T0, T3 move down 90,90
		sleep(3); //6.5 sec
		...
		usleep(1000000);
		legma((98-angg)*300,85*300); //T3 move down fist, T0 not move
		usleep(6800000);
...
int mode_021()	//---Alignment & Calculated the tilt angle
{
    /*---Time---*/
    time_t t1 = time(NULL);
	/*---"depth_find" Function Variable---*/
    ...
    /*---Data Record - Open---*/
    FILE *M2XD=fopen("/home/ubuntu/CodeBlocks/TrackedRobot_Control/Recore Data/M2_XtionDistance.txt","a");
    FILE *M2PL=fopen("/home/ubuntu/CodeBlocks/TrackedRobot_Control/Recore Data/M2_PixelLocation.txt","a");
    FILE *M2VL=fopen("/home/ubuntu/CodeBlocks/TrackedRobot_Control/Recore Data/M2_VelLeft.txt","a");
    FILE *M2VR=fopen("/home/ubuntu/CodeBlocks/TrackedRobot_Control/Recore Data/M2_VelRight.txt","a");
    FILE *M2dldr=fopen("/home/ubuntu/CodeBlocks/TrackedRobot_Control/Recore Data/M2_dldr.txt","a");
	...
	while(d>600)
	{
		...
		if(d21<=20)
		{
			...
			if(counter21<830) //5F:830, 4F:680
			{
				key1=3;
			}

			if(key1!=1 && counter21>800)	//5F:820, 4F:670 ; too far ,TR fwd org=1100  depthMD(mid_x2,mid_y2)>900
			{
				key1=1;
				printf("Too Far\n");
				printf("%d\n",counter21);
			...
			else if(key1!=2 && counter21<620) //5F:780, 4F:590 ; too close,TR back //900 depthMD(mid_x2,mid_y2)<800
			{
				key1=2;
				printf("Too Close\n");
				bodyact("stop");
...
void mode_03()	//---up stairs prepare
{
	/*---Time---*/
    time_t t1 = time(NULL);
	...
	if(angg<45 && angg>20)
	{
		...
		bodyact("fwd");
		usleep(4000000);
		legma(90*300,85*300); //T3 move down fist, T0 not move
		usleep(6800000);
		...
		/*---03---*/
		legma(90*300,90*300); //T0 move down, T3 not move
		usleep(6500000);
		bodyact("stop");
		usleep(50000);
